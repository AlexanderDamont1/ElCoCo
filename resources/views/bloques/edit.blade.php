                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ isset($quoteBlock) ? route('admin.quote-blocks.update', $quoteBlock) : route('admin.quote-blocks.store') }}" 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="maintenance-config" class="config-section" style="display: none;">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" name="config[periodicity]">
                        ...
                        <div class="flex justify-between items-center mt-6 pt-6 border-t border-gray-200">
                            <a href="{{ route('admin.quote-blocks.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                Cancelar
                            </a>
